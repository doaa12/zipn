...
/**
 * @author zby 2014-9-8 下午6:11:22
 */
public class SnCal {

	public String getSn(String address, String ak, String sk) throws Exception {
	...
	public static void main(String[] args) throws UnsupportedEncodingException,
		...
		Map<String,String> paramsMap = new LinkedHashMap<String, String>();
		paramsMap.put("address", "上海市浦东新区中科路2500弄");
		paramsMap.put("output", "json");
		paramsMap.put("ak", "cojnsWM10PDiMbvVHnegmvv2");
		
		// 调用下面的toQueryString方法，对LinkedHashMap内所有value作utf8编码，拼接返回结果address=%E7%99%BE%E5%BA%A6%E5%A4%A7%E5%8E%A6&output=json&ak=yourak
		String paramsStr = snCal.toQueryString(paramsMap);
		
		// 对paramsStr前面拼接上/geocoder/v2/?，后面直接拼接yoursk得到/geocoder/v2/?address=%E7%99%BE%E5%BA%A6%E5%A4%A7%E5%8E%A6&output=json&ak=yourakyoursk
		String wholeStr = new String("/geocoder/v2/?" + paramsStr + "jqw6EAnb5Hpx0B59idvG2r7gMCKSQUVM");
