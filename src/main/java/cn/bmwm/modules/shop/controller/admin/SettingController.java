...
import cn.bmwm.common.utils.CommonAttributes;
...
import cn.bmwm.modules.sys.model.Setting.ConsultationAuthority;
import cn.bmwm.modules.sys.model.Setting.ReviewAuthority;
import cn.bmwm.modules.sys.model.Setting.RoundType;
import cn.bmwm.modules.sys.model.Setting.StockAllocationTime;
import cn.bmwm.modules.sys.model.Setting.WatermarkPosition;
...
public class SettingController extends BaseController {
	...
	public String update(Setting setting, MultipartFile watermarkImageFile, RedirectAttributes redirectAttributes) {
		...
		try {
			org.springframework.core.io.Resource resource = new ClassPathResource(CommonAttributes.APPLICATION_PROPERTIES_PATH);
			...
			if (setting.getIsDevelopmentEnabled()) {
				if (!templateUpdateDelay.equals("0") || !messageCacheSeconds.equals("0")) {
					...
					properties.store(outputStream, "zipn PROPERTIES");
				}
			} else {
				if (templateUpdateDelay.equals("0") || messageCacheSeconds.equals("0")) {
					outputStream = new FileOutputStream(resource.getFile());
