...
<%@page import="cn.bmwm.modules.sys.model.Setting"%>
<%@page import="cn.bmwm.modules.sys.utils.SettingUtils"%>
<%@page import="cn.bmwm.common.utils.SpringUtils"%>
<%@page import="cn.bmwm.modules.sys.model.Setting.CaptchaType"%>
<%@page import="cn.bmwm.modules.sys.model.Setting.AccountLockType"%>
<%@page import="cn.bmwm.modules.shop.service.RSAService"%>
...
<body>
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="/admin/login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.gif" alt="logo" />
						</td>
						<th>
		...
		<%-- 		<div class="powered">COPYRIGHT©2013  ALL RIGHTS RESERVED.</div>
				<div class="link">
