...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.virtualShopCategory.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" id="name" name="name" class="text" value="${virtualCategory.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="order" class="text" value="${virtualCategory.order}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
