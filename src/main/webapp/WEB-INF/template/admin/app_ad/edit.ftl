...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.appAdvertise.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table id="shopTable" class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="order" name="order" value="${ad.order}" class="text_medium" maxlength="50" title="${message("admin.appAdvertise.orderTitle")}"/>
				</td>
			</tr>
		</table>
		<table class="input">
